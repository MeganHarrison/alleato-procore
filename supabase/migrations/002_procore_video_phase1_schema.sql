-- Migration: 002_procore_video_phase1_schema.sql
-- Description: Phase 1 Database Schema Updates for Procore Video Walkthrough Implementation
-- Date: 2025-12-13
...
-- 3.2 Update prime_contracts table
...
CREATE POLICY "Users can view SOVs for their projects" ON schedule_of_values
  FOR SELECT USING (
    EXISTS (
      ...
      WHERE (p.id = (SELECT project_id FROM prime_contracts WHERE id = schedule_of_values.contract_id)
