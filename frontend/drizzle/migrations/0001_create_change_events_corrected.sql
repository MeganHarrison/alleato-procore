-- Change Events Module Migration (Corrected for existing schema)
-- Created: 2026-01-10
-- Purpose: Complete schema for change events management matching actual database types
...
CREATE TABLE IF NOT EXISTS change_events (
    ...
    prime_contract_id BIGINT REFERENCES contracts(id) ON DELETE SET NULL,
    description TEXT,
...
CREATE OR REPLACE FUNCTION get_next_change_event_number(p_project_id BIGINT)
RETURNS VARCHAR AS $$
DECLARE
    next_num INTEGER;
BEGIN
