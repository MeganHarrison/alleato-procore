...
export default function EditContractPage() {
  ...
  const initialData: Partial<ContractFormData> = {
    ...
    ownerClientId: contract.vendor_id || undefined,
    ...
    estimatedCompletionDate: contract.end_date ? new Date(contract.end_date) : undefined,
  ...
  return (
    <>
      <ProjectPageHeader
        ...
        breadcrumbs={[
          { label: 'Contracts', href: `/${projectId}/contracts` },
          { label: contract.contract_number || contractId, href: `/${projectId}/contracts/${contractId}` },
          { label: 'Edit' },
        ]}
        actions={
          <Button
