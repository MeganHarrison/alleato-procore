...
import { Plus, MoreHorizontal, Eye, Edit, Trash2, Download, FileText } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
interface Drawing {
  ...
  revision: string;
  status: 'issued_for_construction' | 'issued_for_review' | 'superseded' | 'void';
  uploadedBy: string;
  uploadedAt: string;
  fileSize: string;
}
  ...
  const columns: ColumnDef<Drawing>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge className={disciplineColors[discipline] || 'bg-gray-100 text-gray-700'}>
            {discipline}
          </Badge>
        );
      },
    ...
    <div className="flex flex-col h-full p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Construction drawings and blueprints</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white rounded-lg border p-4">
          <div className="text-sm font-medium text-gray-500">For Construction</div>
