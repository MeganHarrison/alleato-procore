...
interface FinancialState {
  ...
  updatePrimeContract: (
    id: string,
    primeContract: Partial<PrimeContract>,
  ) => void;
  ...
  setLoading: (
    module: keyof FinancialState["isLoading"],
    loading: boolean,
  ) => void;
  setError: (
    module: keyof FinancialState["errors"],
    error: string | null,
  ) => void;
}
  ...
  devtools(
    (set) => ({
      ...
      addChangeEvent: (changeEvent) =>
        set((state) => ({
          changeEvents: [...state.changeEvents, changeEvent],
        })),
      ...
      addPrimeContract: (primeContract) =>
        set((state) => ({
          primeContracts: [...state.primeContracts, primeContract],
        })),
