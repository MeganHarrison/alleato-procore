import { pgTable, uuid, text, boolean, numeric, timestamp, integer } from 'drizzle-orm/pg-core';
...
export type NewSubcontractAttachment = typeof subcontractAttachments.$inferInsert;
