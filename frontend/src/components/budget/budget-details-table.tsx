        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50">
              ...
              <TableHead className="font-semibold text-right">Original Budget Amount</TableHead>
              <TableHead className="font-semibold text-right">Budget Changes</TableHead>
              <TableHead className="font-semibold text-right">Pending Budget Changes</TableHead>
              <TableHead className="font-semibold text-right">Approved COs</TableHead>
              <TableHead className="font-semibold text-right">Committed Costs</TableHead>
              <TableHead className="font-semibold text-right">Pending Cost Changes</TableHead>
              <TableHead className="font-semibold text-right">Direct Costs</TableHead>
              <TableHead className="font-semibold text-right">Forecast to Complete</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {data.map((item) => (
