...
import type { DirectoryFilters, PersonWithDetails } from '@/components/directory/DirectoryFilters';
...
export function useDirectory(
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Fetch from API
      const response = await fetch(`/api/projects/${projectId}/directory/people?${params}`);
