...
Verifier writes report to:
  documentation/1-project-mgmt/in-progress/[feature-name]/VERIFICATION-[task-name].md
    ↓
...
**Location:** `documentation/1-project-mgmt/in-progress/[feature-name]/VERIFICATION-[name].md`
...
**Fix Applied:**
- Moved verification reports to `documentation/1-project-mgmt/complete/`
...
- [ ] Verification report created in `documentation/1-project-mgmt/complete/`
...
Location: `documentation/1-project-mgmt/templates/verification.md`
...
- Evidence: documentation/1-project-mgmt/complete/verification-[name].md
