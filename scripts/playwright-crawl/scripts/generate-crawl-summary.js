...
function extractUIComponents(pages) {
  ...
  for (const page of pages) {
    ...
    // V1: systemActions[] (scheduling and earlier crawls)
    ...
    // V2: clickableDetails[], menuItems[], tabDetails[] (drawings and newer crawls)
    ...
    if (Array.isArray(meta.menuItems)) {
