...
## How to use ExecPlans and [PLANS.md](http://plans.md/)

When authoring an executable specification (ExecPlan), follow [PLANS.md](http://plans.md/) *to the letter*. If it is not in your context, refresh your memory by reading the entire [PLANS.md](http://plans.md/) file. Be thorough in reading (and re-reading) source material to produce an accurate specification. When creating a spec, start from the skeleton and flesh it out as you do your research.
